...
macro_rules! impl_state_machine {
    ($name:ident, $($states:ident),+) => {
        paste::paste! {
            ...
            $(
                // state enter
                #[derive(Debug, bevy::prelude::Component, bevy_inspector_egui::prelude::Inspectable)]
            ...
            #[derive(Debug, Clone, Copy, PartialEq, Eq, bevy_inspector_egui::prelude::Inspectable)]
            pub enum [<$name State>] {
                $(
                    $states,
                )*
